...
public class SetProfile extends AppCompatActivity {
    ...
    private String ImageUriAcesToken;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mgetuserimageinimageview = findViewById(R.id.getuserimageview);
    ...
    private void sendDataToRealTimeDatabase() {
        ...
        Toast.makeText(getApplicationContext(),"User profile added",Toast.LENGTH_SHORT).show();
        sendImagetoStorage();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ImageUriAcesToken = uri.toString();
    ...
    private void sendDataToCloudFirestore() {
        ...
        userdata.put("image", ImageUriAcesToken);
        ...
        documentReference.set(userdata).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(getApplicationContext(),"Data sended to Colud Firestore successfully", Toast.LENGTH_SHORT).show();
            }
        });
